...
public class FindidActivity extends AppCompatActivity implements View.OnClickListener {  // "아이디 찾기" 화면
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customEdit = (CustomEdit) findViewById(R.id.custom_findId_Name);
        ed_name = customEdit.getEditText();                                     // 이름 기입 란
        customEdit = (CustomEdit) findViewById(R.id.custom_findId_Email);
        ed_email = customEdit.getEditText();                                    // 이메일 기입 란
