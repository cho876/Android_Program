...
public class ChatAdapter extends ArrayAdapter<ChatDTO> {
    ...
    private class ViewAnotherHolder {
        ...
        private void bindView(View convertView) {
            userImage = (ImageView) convertView.findViewById(R.id.listitem_another_img);
    ...
    /*  자신의 프로필 사진 Update  */
    public void updateImage(ChatDTO chatDTO, final ImageView profile) {
        FirebaseStorage storage = FirebaseStorage.getInstance();
        StorageReference storageReference = storage.getReferenceFromUrl("gs://chatdb-59f3b.appspot.com").child("images/");
        String fileName = chatDTO.getUserEmail();
