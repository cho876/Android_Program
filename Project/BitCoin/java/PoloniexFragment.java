...
public class PoloniexFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_polonix, container, false);
        initView(rootView);
        initHandler();
        joinThread(handler);
        return rootView;
    ...
    private void initView(View view) {
        tv_exchange = (TextView) view.findViewById(R.id.poloniex_exchange);

        tv_kr_max = (TextView) view.findViewById(R.id.poloniex_kr_max);
        tv_us_max = (TextView) view.findViewById(R.id.poloniex_us_max);

        tv_kr_min = (TextView) view.findViewById(R.id.poloniex_kr_min);
        tv_us_min = (TextView) view.findViewById(R.id.poloniex_us_min);

        tv_kr_change = (TextView) view.findViewById(R.id.poloniex_kr_change);
        tv_us_change = (TextView) view.findViewById(R.id.poloniex_us_change);
        tv_percent = (TextView) view.findViewById(R.id.poloniex_percent);

        tv_kr_premium_change = (TextView) view.findViewById(R.id.poloniex_kr_premium_change);
        tv_us_premium_change = (TextView) view.findViewById(R.id.poloniex_us_premium_change);
        tv_premium_percent = (TextView) view.findViewById(R.id.poloniex_premium_percent);

        tv_volume = (TextView) view.findViewById(R.id.poloniex_volume);
    }
    ...
    private void joinThread(Handler handler) {
        ...
        toJsonThread.setTitle("poloniex");
