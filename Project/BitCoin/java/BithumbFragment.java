 ...
 * 빗썸 정보 Fragment
 */
public class BithumbFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_bit_humb, container, false);
        initView(rootView);
        initHandler();
        joinThread(handler);
        return rootView;
    ...
    private void initView(View view) {
        tv_exchange = (TextView) view.findViewById(R.id.bithumb_exchange);

        tv_kr_max = (TextView) view.findViewById(R.id.bithumb_kr_max);
        tv_us_max = (TextView) view.findViewById(R.id.bithumb_us_max);

        tv_kr_min = (TextView) view.findViewById(R.id.bithumb_kr_min);
        tv_us_min = (TextView) view.findViewById(R.id.bithumb_us_min);

        tv_kr_change = (TextView) view.findViewById(R.id.bithumb_kr_change);
        tv_us_change = (TextView) view.findViewById(R.id.bithumb_us_change);
        tv_percent = (TextView) view.findViewById(R.id.bithumb_percent);

        tv_kr_premium_change = (TextView) view.findViewById(R.id.bithumb_kr_premium_change);
        tv_us_premium_change = (TextView) view.findViewById(R.id.bithumb_us_premium_change);
        tv_premium_percent = (TextView) view.findViewById(R.id.bithumb_premium_percent);

        tv_volume = (TextView) view.findViewById(R.id.bithumb_volume);
    }
