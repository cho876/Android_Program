...
public class FindIdActivity extends AppCompatActivity implements View.OnClickListener {  // "아이디 찾기" 화면
    ...
    public void initView() {
        ...
        text_id = (TextView) findViewById(R.id.searchId_btn);                 // 검색 결과 란
        bSearch = (Button) findViewById(R.id._findid_search);                   // 아이디 찾기 버튼
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.button_right:
                Intent go_pw = new Intent(this, FindPwActivity.class);
                startActivity(go_pw);
                break;
    ...
    private void connectToDB(String userName, String userEmail, final TextView tv) {
        retrofitConnect.getUserIdByAsync(userName, userEmail, new RetrofitConnect.callBack<UserDAO>() {
            @Override
            public void execute(UserDAO user) {
