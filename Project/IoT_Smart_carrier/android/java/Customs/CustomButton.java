...
public class CustomButton extends LinearLayout {
    ...
    private void setTypedArray(TypedArray typedArray) {
        String sLeft = typedArray.getString(R.styleable.BtnAttrs_btn_left_txt);          // Left Button Set
        leftBtn.setText(sLeft);

        String sRight = typedArray.getString(R.styleable.BtnAttrs_btn_right_txt);        // Right Button Set
