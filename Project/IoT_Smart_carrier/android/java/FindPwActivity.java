...
public class FindPwActivity extends AppCompatActivity implements View.OnClickListener {  // "비밀번호 찾기" 화면
    ...
    public void initView() {
        ...
        tv_pw = (TextView) findViewById(R.id.searchpw_btn);                // 검색 결과 란
        bSearch = (Button) findViewById(R.id._findpw_search);                // 비밀번호 찾기 버튼
    ...
    private void connectToDB(String userEmail, String userId, final TextView tv) {
        retrofitConnect.getUserPwByAsync(userEmail, userId, new RetrofitConnect.callBack<UserDAO>() {
            @Override
